      ...
      <div class="warpper" style="box-shadow:0px 2px 5px rgba(18,31,62,0.16);border-radius:5px;">
        ...
        <div class="order_search">
          ...
          <div class="int_model mt30">
            ...
            <div v-if="ishow">
              <i style="color: #EF5565;margin-right: 10px;">*</i>发动机号 &nbsp;&nbsp;<el-input
            ...
            <div v-if="!ishow">
              <i style="color: #EF5565;margin-right: 10px;">*</i>挂车材质 &nbsp;&nbsp;<el-input
                v-model="form.engine_num"
                style="width: 60%"
                placeholder="请输入"
              />
            ...
            <div>
              <i style="color: #EF5565;margin-right: 10px;">*</i>品牌型号 &nbsp;&nbsp;<el-input
                v-model="form.brand_num"
                style="width: 60%"
                placeholder="请输入"
              />
            </div>
          ...
          <div class="int_model mt30">
            <div>
              ...
              <el-select v-model="form.length" placeholder="请选择" style="width: 28%;">
                ...
                <el-option label="20米" value="16" />
                <el-option label="21米" value="17" />
              </el-select>
            </div>
            <div>
              ...
              <p style="display: inline-block;width: 60%;border-radius: 4px;border: 1px solid #DCDFE6;">
                <el-input v-model="form.load" style="width: 90%;" class="bordernone" placeholder="请输入" />吨
              </p>
            </div>
            <div>
              <i style="color: #EF5565;margin-right: 10px;">*</i>车辆容量 &nbsp;
              <p style="display: inline-block;width: 60%;border-radius: 4px;border: 1px solid #DCDFE6;">
                <el-input v-model="form.volume" style="width: 76%;" class="bordernone" placeholder="请输入" />/立方米
              </p>
            </div>
          </div>
          <div class="int_model mt30">
