    ...
    <div class="container">
        ...
        <div class="order_search">
            <div class="int_model">
                ...
                <div>
                    车牌简称 &nbsp;&nbsp;<el-input style="width: 60%" v-model="number2" placeholder="请输入车辆号码"></el-input>
                </div>
            </div>
            <div class="int_model mt36">
                ...
                <div>
                    里程区间 &nbsp;
                    <el-input style="width: 28%" v-model="number" placeholder="请输入"></el-input>至
                    <el-input style="width: 28%" v-model="number" placeholder="请输入"></el-input>
                </div>
                <div style="padding: 10px 0">
                    <el-checkbox v-model="checked">仅展示车辆最新一次提醒</el-checkbox>
                </div>
            </div>
