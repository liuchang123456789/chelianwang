<template>
    <div class="container">
        ...
        <div class="order_search">
            <div class="int_model">
                <div>
                    登录账号 &nbsp;&nbsp;<el-input style="width: 60%" v-model="number" placeholder="请输入"></el-input>
                </div>
                <div>
                    用户姓名 &nbsp;&nbsp;<el-input style="width: 60%" v-model="name" placeholder="请输入"></el-input>
                </div>
                <div>
                    用户工号 &nbsp;&nbsp;<el-input style="width: 60%" v-model="name" placeholder="请输入"></el-input>
                </div>
            </div>
            <div class="int_model mt36">
                <div>
                    用户角色 &nbsp;&nbsp;<el-input style="width: 60%" v-model="name" placeholder="请输入"></el-input>
                </div>
                <div>
                    所属部门 &nbsp;
