<template>
    <div class="container">
        ...
        <div class="order_search">
            <div class="int_model">
                <div>
                    订单编号 &nbsp;&nbsp;<el-input style="width: 50%" v-model="number" placeholder="请输入编号"></el-input>
                </div>
                <div>
                    客户名称 &nbsp;&nbsp;<el-input style="width: 50%" v-model="name" placeholder="请输入名称"></el-input>
                </div>
                <div>
                    车牌号码 &nbsp;&nbsp;<el-input style="width: 50%" v-model="number2" placeholder="请输入车辆号码"></el-input>
                </div>
            </div>
            <div class="int_model mt36">
                <div>
                    线路名称 &nbsp;&nbsp;<el-input style="width: 50%" v-model="number3" placeholder="请输入线路关键字"></el-input>
                </div>
                <div>
                    靠台时间 &nbsp;
