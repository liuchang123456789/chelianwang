<template>
    <div class="container">
        ...
        <div class="order_search">
            <div class="int_model">
                <div>
                    司机姓名 &nbsp;&nbsp;<el-input style="width: 50%" v-model="number" placeholder="请输入账号"></el-input>
                </div>
                <div>
                    手机号 &nbsp;&nbsp;<el-input style="width: 53%" v-model="name" placeholder="请输入名称"></el-input>
                </div>
                <div></div>
            </div>
            <div class="int_model mt36">
                <div>
                    考勤日历 &nbsp;
                    <el-select style="width: 50%" v-model="value" placeholder="请选择">
                        <el-option
                ...
                <div>
                    平均工时 &nbsp;
                    <el-input style="width: 23%" v-model="name" placeholder="请输入"></el-input> ~ <el-input style="width: 23%" v-model="name" placeholder="请输入"></el-input>
                </div>
            </div>
        ...
        <div class="tab_warpper">
            ...
            <el-table :data="tableData" style="margin:1%;width: 98%" @selection-change="handleSelectionChange">
                <el-table-column type="selection" width="36"></el-table-column>
                <el-table-column sortable fixed prop="serial" label="司机姓名" width="150"></el-table-column>
                <el-table-column prop="customer" label="手机号" width="150"></el-table-column>
                <el-table-column prop="roadname" label="订单号" width="150"></el-table-column>
                <el-table-column prop="roadmap" label="出勤天数" width="150"></el-table-column>
                <el-table-column prop="vehicle_num" label="平时工时" width="150"></el-table-column>
