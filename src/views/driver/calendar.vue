<template>
    <div class="container">
        ...
        <div class="tab_warpper">
            ...
            <el-table style="margin: 0 1.5%;width: 97%;text-align: center"
                :data="tableData3">
