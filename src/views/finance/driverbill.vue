    ...
    <div class="container">
        ...
        <div class="order_search">
            <div class="int_model">
                ...
                <div>
                    司机名称 &nbsp;&nbsp;<el-input style="width: 60%" v-model="name" placeholder="请输入"></el-input>
                </div>
                <div>
                    订单编号 &nbsp;&nbsp;<el-input style="width: 60%" v-model="name" placeholder="请输入"></el-input>
                </div>
                <div>
            ...
            <div class="int_model mt36">
                ...
                <div>
                    线路名称 &nbsp;&nbsp;<el-input style="width: 60%" v-model="name" placeholder="请输入"></el-input>
                </div>
                <div>
                    操作人 &nbsp;&nbsp;<el-input style="width: 63%" v-model="name" placeholder="请输入"></el-input>
                </div>
                <div></div>
            </div>
        ...
        <div class="tab_warpper">
            <div class="tab_title clearfix">
                ...
                <div class="right">
                    ...
                    <el-button type="primary">表格设置+</el-button>
                </div>
            </div>
