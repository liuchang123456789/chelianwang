<template>
    <div class="container">
        ...
        <div class="order_search">
            <div class="int_model">
                <div>
                    站点名称 &nbsp;&nbsp;<el-input style="width: 60%" v-model="number" placeholder="请输入编号"></el-input>
                </div>
                <div>
                    车牌号 &nbsp;&nbsp;<el-input style="width: 60%" v-model="name" placeholder="请输入名称"></el-input>
                </div>
                <div>
                    到达时间 &nbsp;
            ...
            <div class="int_model mt36">
                <div>
                    车辆出入状态 &nbsp;
                    <el-select v-model="value" style="width: 54%" placeholder="请选择">
                        <el-option
                ...
                <div>
                    车辆状态 &nbsp;
                    <el-select v-model="value" style="width: 57%" placeholder="请选择">
                        <el-option
                            v-for="item in options"
                            :key="item.value"
                            :label="item.label"
        ...
        <div class="tab_warpper">
            ...
            <el-table :data="tableData" border style="margin:1%;width: 98%;text-align: center" @selection-change="handleSelectionChange">
                ...
                <el-table-column sortable fixed prop="serial" label="车牌号" width="150"></el-table-column>
                <el-table-column prop="customer" label="站点名称" width="200"></el-table-column>
                <el-table-column prop="roadname" label="到达时间" width="200"></el-table-column>
                <el-table-column prop="roadmap" label="离开时间" width="200"></el-table-column>
                <el-table-column prop="vehicle_num" label="停留时长(分钟)" width="200"></el-table-column>
                <el-table-column prop="type_huo" label="车辆出入状态" width="200"></el-table-column>
                <el-table-column prop="information" label="车辆状态" width="200"></el-table-column>
