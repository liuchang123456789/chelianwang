<template>
    <div class="container">
        ...
        <div class="order_search">
            <div class="int_model">
                <div>
                    线路编号 &nbsp;&nbsp;<el-input style="width: 50%" v-model="number" placeholder="请输入编号"></el-input>
                </div>
                <div>
                    线路名称 &nbsp;&nbsp;<el-input style="width: 50%" v-model="name" placeholder="请输入名称"></el-input>
                </div>
                <div>
                    站点名称 &nbsp;&nbsp;<el-input style="width: 50%" v-model="name" placeholder="请输入名称"></el-input>
                </div>
                <div><el-checkbox v-model="checked">待我审核</el-checkbox></div>
            </div>
            <div class="int_model mt36">
                ...
                <div>
                    站长名称 &nbsp;&nbsp;<el-input style="width: 50%" v-model="name" placeholder="请输入名称"></el-input>
                </div>
                <div></div>
            </div>
