    ...
    <div class="container">
        ...
        <div class="order_search">
            <div class="int_model">
                ...
                <div>
                    线路名称 &nbsp;&nbsp;<el-input style="width: 60%" v-model="name" placeholder="请输入名称"></el-input>
                </div>
                <div>
                    站点名称 &nbsp;&nbsp;<el-input style="width: 60%" v-model="name" placeholder="请输入名称"></el-input>
                </div>
            </div>
            <div class="int_model mt36">
                ...
                <div>
                    上一站上下车状态 &nbsp;
                    <el-select v-model="value" style="width: 48%" placeholder="请选择">
                        <el-option
                            v-for="item in options"
                            :key="item.value"
                            :label="item.label"
                ...
                <div>
                    车牌号 &nbsp;&nbsp;<el-input style="width: 63%" v-model="name" placeholder="请输入"></el-input>
                </div>
            </div>
