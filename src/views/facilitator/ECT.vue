<template>
    <div class="container">
        ...
        <div class="order_search">
            <div class="int_model">
                <div>
                    ECT卡号 &nbsp;&nbsp;<el-input style="width: 60%" v-model="number" placeholder="请输入"></el-input>
                </div>
                <div>
                    服务商名称 &nbsp;&nbsp;<el-input style="width: 60%" v-model="name" placeholder="请输入"></el-input>
                </div>
                <div>
                    车牌号 &nbsp;&nbsp;<el-input style="width: 60%" v-model="name" placeholder="请输入"></el-input>
                </div>
            </div>
            <div class="int_model mt36">
                <div>
                    卡类型 &nbsp;
                    <el-select v-model="value" style="width: 63%" placeholder="请选择">
                        <el-option
        ...
        <div class="tab_warpper">
            <div class="tab_title clearfix">
                ...
                <div class="right">
                    ...
                    <el-button type="primary">导入消费者记录</el-button>
