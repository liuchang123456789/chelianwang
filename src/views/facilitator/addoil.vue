<template>
    <div class="container">
        ...
        <div class="order_search">
            <div class="int_model">
                <div>
                    油卡卡号 &nbsp;&nbsp;<el-input style="width: 50%" v-model="number" placeholder="请输入"></el-input>
                </div>
                <div>
                    服务商 &nbsp;
                    <el-select v-model="value" style="width: 52%" placeholder="请选择">
                        <el-option
            ...
            <div class="int_model mt36">
                ...
                <div>
                    充值余额 &nbsp;&nbsp;<el-input style="width: 50%" v-model="number" placeholder="请输入"></el-input>
                </div>
            </div>
        </div>
