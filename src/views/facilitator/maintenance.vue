    ...
    <div class="container">
        ...
        <div class="order_search">
            <div class="int_model">
                ...
                <div>
                    服务商名称 &nbsp;&nbsp;<el-input style="width: 60%" v-model="name" placeholder="请输入名称"></el-input>
                </div>
                <div>
        ...
        <div class="tab_warpper">
            <div class="tab_title clearfix">
                ...
                <div class="right">
                    ...
                    <el-button style="background: #31D093;color: #fff;">表格设置</el-button>
                </div>
            </div>
