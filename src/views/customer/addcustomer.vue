<template>
	<div class="container">
		...
		<div class="warpper mt10" style="box-shadow:0px 2px 5px rgba(18,31,62,0.16);border-radius:5px;background: #fff;padding: 26px">
			...
			<div class="int_model mt30">
				<div>
					<i style="color: #EF5565">*</i>联系人 &nbsp;&nbsp;<el-input v-model="form.name" style="width: 62%" placeholder="请输入"></el-input>
				</div>
				<div>
					<i style="color: #EF5565">*</i>联系电话 &nbsp;&nbsp;<el-input v-model="form.tele_phone" style="width: 59%" placeholder="请输入"></el-input>
				</div>
				<div>
...
<script>
	import {setAdd} from '../../api/customer'
	export default {
		data() {
			return {
				form: {
