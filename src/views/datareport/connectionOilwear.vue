    ...
    <div class="container">
        ...
        <div class="order_search">
            <div class="int_model">
                ...
                <div>
                    客户名称 &nbsp;&nbsp;<el-input style="width: 60%" v-model="name" placeholder="请输入"></el-input>
                </div>
                <div>
                    车牌号码 &nbsp;&nbsp;<el-input style="width: 60%" v-model="name" placeholder="请输入"></el-input>
                </div>
            </div>
            <div class="int_model mt36">
                ...
                <div>
                    站点名称 &nbsp;&nbsp;<el-input style="width: 60%" v-model="name" placeholder="请输入"></el-input>
                </div>
            </div>
